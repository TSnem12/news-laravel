...
<div class="form-group">
    ...
    <select class="form-control" name="district_id" id="exampleSelectGender">
      ...
      <option value="{{ $district->id }}" <?php if($district->id == $subdistrict->district_id)  echo 'selected';  ?> >
          
          {{ $district->district_en }} | {{ $district->district_ar }}
        </option>
      @endforeach
    </select>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="subdistrict_ar"  value="{{ $subdistrict->subdistrict_ar }}">
