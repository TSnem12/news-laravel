        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('update.post', $posts->id) }}" method="post"
                                ...
                                <select class="form-control" id="exampleSelectGender" name="category_id">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            ...
                                            {{ $category->category_en }} | {{ $category->category_ar }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="form-control" name="subcategory_id" id="subcategory_id">
                                    ...
                                    @foreach ($subcategories as $subcategory)
                                        <option value="{{ $subcategory->id }}"
                                            {{ $posts->subcategory_id == $subcategory->id ? 'selected' : '' }}>
                                ...
                                <select class="form-control" id="exampleSelectGender" name="district_id">
                                    ...
                                    @foreach ($districts as $district)
                                        <option value="{{ $district->id }}"
                                            {{ $posts->district_id == $district->id ? 'selected' : '' }}>
                                            {{ $district->district_en }} | {{ $district->district_ar }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="form-control" id="subdistrict_id" name="subdistrict_id">
                                    ...
                                    @foreach ($subdistricts as $subdistrict)
                                        <option value="{{ $subdistrict->id }}"
                                            {{ $posts->subdistrict_id == $subdistrict->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img src="{{ asset('images/post_image/' . $posts->image) }}"
                                    style="height: 70px; width: 90px;">
                                <input type="hidden" class="form-control" id="exampleInputName1" name="old_image"
                                    value="{{ $posts->image }}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <label class="form-check-label col-md-6" style="margin-left: 20px">
                                <input type="checkbox" name="headline" class="form-check-input" value="1"
                                    {{ $posts->headline == 1 ? 'checked' : '' }}> Headline <i
                                    class="input-helper"></i></label>

                            <label class="form-check-label col-md-6" style="margin-left: 20px">
                                <input type="checkbox" name="bigthumbnail" class="form-check-input" value="1"
                                    {{ $posts->bigthumbnail == 1 ? 'checked' : '' }}> General Big Thumbnail <i
                                    class="input-helper"></i></label>

                            <label class="form-check-label col-md-6" style="margin-left: 20px">
                                <input type="checkbox" name="first_section" class="form-check-input" value="1"
                                    {{ $posts->first_section == 1 ? 'checked' : '' }}> First Section <i
                                    class="input-helper"></i></label>

                            <label class="form-check-label col-md-6" style="margin-left: 20px">
                                <input type="checkbox" name="first_section_thumbnail" class="form-check-input"
                                    value="1" {{ $posts->first_section_thumbnail == 1 ? 'checked' : '' }}> First
                                Section BigThumbnail <i class="input-helper"></i></label>

                            <label class="form-check-label col-md-6" style="margin-left: 20px">
                                <input type="checkbox" name="thumbnail" class="form-check-input" value="1"
                                    {{ $posts->bigthumbnail == 1 ? 'checked' : '' }}> BigThumbnail <i
                                    class="input-helper"></i></label>
