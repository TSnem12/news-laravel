                    ...
                    <form class="forms-sample" action="{{ route('update.photo', $photo->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img src="{{ asset('images/photo_gallery/' . $photo->photo) }}" style="width: 100px;">
                                <input type="hidden" name="old_photo" class="form-control-file"
                                    id="exampleFormControlFile1" value="{{ $photo->photo }}">
                            </div>
                        </div>
