                ...
                <div class="header-icon">
                    <ul>
                        ...
                        @if (session()->get('lang') == 'arabic')
                            ...
                            &nbsp;&nbsp;&nbsp;
                        @else
                            <li class="version"><a href="{{ route('lang.arabic') }}"><B>العربية</B></a></li>
                            &nbsp;&nbsp;&nbsp;
                        @endif
                        <!-- login-start -->
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="{{ $social->facebook }}" target="_blank"><i class="fa fa-facebook"
                                            aria-hidden="true" target="_blank"></i> Facebook</a>
                ...
                <div class="top-add">
                    ...
                    @else
                        <a href="{{ $horizontal->link }}" target="_blank"><img
                                src=" {{ asset('images/ads/' . $horizontal->ads) }}" alt="" /></a>
                    @endif
                </div>
            </div>
        </div>
...
@php
    $headline = DB::table('posts')->where('posts.headline', 1)->get();

    $notice = DB::table('notices')->get()->first();
@endphp
